...
export class FeedComponent implements OnInit {
  ...
  constructor(private rou:ActivatedRoute,private pose:PostserviceService,private spinnerService: NgxSpinnerService,private sanitizer:DomSanitizer,private dialogRef: MatDialogRef<CreatepostComponent>,private ss:UserserviceService,private ngxService: NgxUiLoaderService,private rr:Router){
